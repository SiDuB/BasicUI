...
function MODULE:OnEnable()
	...
	PBFrame.Power.Below:SetTexture([[_retail_\Interface\AddOns\BasicUI\Media\textureArrowBelow]])
	...
	PBFrame.Power.Above:SetTexture([[_retail_\Interface\AddOns\BasicUI\Media\textureArrowAbove]])
